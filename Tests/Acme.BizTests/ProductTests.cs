...
namespace Acme.Biz.Tests
{
    ...
    public class ProductTests
    {
        ...
        {
            //Arrange 
            var currentProduct = new Product(1, "Saw", "15 inch hand saw");
                        var expected = "Hello Saw (1): 15 inch hand saw";
            //Act
        ...
        public void SayHelloTest()
        {
            ...
            currentProduct.Description = "15 inch hand saw";
            currentProduct.ProductVendor.CompanyName = "ABC Corp";
            var expected = "Hello Saw (1): 15 inch hand saw ABC Corp" + " Available on: ";
